...
const HOLIDAY_CAMP = {
  ...
  weeklyPlan: [
    { week: "Week 1", title: "Computer Basics & Digital Foundations", topics: "Computer packages, typing, internet skills, Canva intro, AI tools, online safety. Project: Personal poster." },
    { week: "Week 2", title: "Graphic Design", topics: "Posters, flyers, social media graphics, branding, Photoshop basics. Project: Business poster." },
    { week: "Week 3", title: "Coding & Web Development", topics: "Scratch, HTML, CSS, simple websites, AI tools for students. Project: Personal webpage." },
    { week: "Week 4", title: "Digital Marketing & Content Creation", topics: "Facebook, Instagram, TikTok, content creation, online business, entrepreneurship. Project: Marketing campaign." },
  ],
